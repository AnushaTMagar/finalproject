...
urlpatterns = [
    path('djadmin/', admin.site.urls, name = 'djadmin'),
    path(r'admin/', include(('apps.customadmin.urls','customadmin'),namespace = 'customadmin')),
...
urlpatterns = [
    ...
    path(r'^about$', views.about_view, name='about'),
    path(r'^help$', views.help_view, name='help'),
    path(r'homepage',views.index_view, name ='index'),
    ...
    path('patientlogin', LoginView.as_view(template_name='patients/patientlogin.html')),
...
urlpatterns +=[
    ...
    path(r'^diagnosis/', include(('apps.diagnosis.urls','diagnosis'), namespace='diagnosis')),
]
