...
def adminclick_view(request):
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request,'customadmin/adminclick.html')
...
def doctorclick_view(request):
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request,'doctors/doctorclick.html')
...
def patientclick_view(request):
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request,'patients/patientclick.html')
...
def afterlogin_view(request):
    if is_admin(request.user):
        ...
        if accountapproval:
            ...
            return render(request,'doctors/doctor_wait_for_approval.html')
    elif is_patient(request.user):
        accountapproval=models.Patient.objects.all().filter(user_id=request.user.id,status=True)
        if accountapproval:
            return redirect('patient-dashboard')
        else:
            return render(request,'patients/patient_wait_for_approval.html')
...
def doctor_dashboard_view(request):
    ...
    return render(request,'doctors/list.html',context=mydict)
...
def doctor_patient_view(request):
    ...
    return render(request,'doctors/doctor_patient.html',context=mydict)
...
def doctor_view_patient_view(request):
    ...
    doctor=models.Doctor.objects.get(user_id=request.user.id) #for profile picture of doctor in sidebar
    return render(request,'doctors/doctor_view_patient.html',{'patients':patients,'doctor':doctor})
...
def doctor_view_discharge_patient_view(request):
    ...
    doctor=models.Doctor.objects.get(user_id=request.user.id) #for profile picture of doctor in sidebar
    return render(request,'doctors/doctor_view_discharge_patient.html',{'dischargedpatients':dischargedpatients,'doctor':doctor})
...
def doctor_appointment_view(request):
    doctor=models.Doctor.objects.get(user_id=request.user.id) #for profile picture of doctor in sidebar
    return render(request,'doctors/doctor_appointment.html',{'doctor':doctor})
...
def doctor_view_appointment_view(request):
    ...
    appointments=zip(appointments,patients)
    return render(request,'doctors/doctor_view_appointment.html',{'appointments':appointments,'doctor':doctor})
...
def doctor_delete_appointment_view(request):
    ...
    patients=models.Patient.objects.all().filter(status=True,user_id__in=patientid)
    appointments=zip(appointments,patients)
    return render(request,'doctors/doctor_delete_appointment.html',{'appointments':appointments,'doctor':doctor})
...
def patient_appointment_view(request):
    ...
    return render(request,'patients/patient_appointment.html',{'patient':patient})
...
def patient_view_doctor_view(request):
    doctors=models.Doctor.objects.all().filter(status=True)
    patient=models.Patient.objects.get(user_id=request.user.id) #for profile picture of patient in sidebar
    return render(request,'patients/patient_view_doctor.html',{'patient':patient,'doctors':doctors})
...
def patient_view_appointment_view(request):
    ...
    return render(request,'patients/patient_view_appointment.html',{'appointments':appointments,'patient':patient})
...
def patient_discharge_view(request):
    ...
    return render(request,'patients/patient_discharge.html',context=patientDict)
...
def aboutus_view(request):
    return render(request,'customadmin/aboutus.html')
